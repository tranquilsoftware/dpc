...
import { OWNER_NAME, OWNER_PIC } from '../globals'

//// THIS IS FOR THE MAIN LANDING PAGE! (LIL CARD THINGO)
const Team = () => {

  return (
    <section id="team" className="relative py-20 bg-transparent mt-[-100px]">
      <ScrollAnimation>
              ...
              <div className="flex flex-col md:flex-row">
                ...
                <div className="p-6 md:p-12">
                  ...
                  <p className="text-content-secondary mt-4">
                    Dill Pickle Launceston is a local bar in Launceston, Tasmania. 
                    {' '}
                    We serve up a range of beers, wines, spirits and local Tasmanian chips 'n' dips!
                  </p>
